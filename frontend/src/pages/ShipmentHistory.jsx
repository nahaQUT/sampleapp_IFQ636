            ...
            <div key={parcel._id} className="bg-white border border-gray-200 rounded p-4 flex justify-between items-center">
              <div className="flex-1">
                <div className="flex items-center space-x-3 mb-2">
                  <span className="text-sm font-semibold text-gray-700">{parcel.trackingNumber}</span>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm text-gray-500">
                  <div>
                    <p><span className="text-gray-600">From:</span> {parcel.sender}</p>
                    <p>{parcel.senderAddress}</p>
                  </div>
                  <div>
                    <p><span className="text-gray-600">To:</span> {parcel.recipient}</p>
