...
const initialCartItems = [
  { id: 1, name: 'Beige Cotton Pant',    price: 24.99, imageUrl: '/CottonPant.png',  qty: 1 },
  { id: 2, name: 'Beige Cotton T shirt', price: 34.99, imageUrl: '/CottonT.png',     qty: 2 },
  { id: 3, name: 'Eco Friendly Bottle',  price: 49.99, imageUrl: '/EcoBottle.png',   qty: 1 },
];
      ...
      <main style={styles.main}>
        ...
        <div style={styles.pageHeader}>
          <div>
            ...
            <p style={styles.pageSubtitle}>{totalQty} item{totalQty !== 1 ? 's' : ''}</p>
          </div>
          ...
          <div style={styles.itemsCol}>
            {subtotal < 100 && (
              <div style={styles.shippingBanner}>
                <span>🌿</span>
                <div style={{ flex: 1 }}>
                  <p style={styles.shippingBannerText}>
            ...
            {subtotal >= 100 && (
              <div style={{ ...styles.shippingBanner, background: '#f0f9f1', border: '1.5px solid #a5d6a7' }}>
                <span>🎉</span>
                <p style={{ ...styles.shippingBannerText, color: '#286934', margin: 0 }}>
            ...
            {cartItems.map(item => (
              <div
                ...
                style={{
                  ...
                  transform:  removingId === item.id ? 'translateX(40px)' : 'translateX(0)',
                ...
                <div style={styles.itemBody}>
                  <div style={styles.itemTop}>
                    <div>
                      ...
                      <p style={styles.itemUnit}>${item.price.toFixed(2)} each</p>
                    </div>
                    <button
            ...
            <div style={styles.summaryCard}>
              ...
              <div style={styles.summaryRows}>
                <div style={styles.summaryRow}>
                  <span style={styles.summaryLabel}>Subtotal ({totalQty} items)</span>
              ...
              <div style={styles.badges}>
                <div style={styles.badge}><span>🔒</span> Secure Checkout</div>
                <div style={styles.badge}><span>♻️</span> Eco Packaging</div>
                <div style={styles.badge}><span>↩️</span> Easy Returns</div>
              </div>
            </div>
          </div>
